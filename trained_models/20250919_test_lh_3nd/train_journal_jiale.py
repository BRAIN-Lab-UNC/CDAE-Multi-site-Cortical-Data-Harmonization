...
from utils_for_harmonization import split_files, split_files_jiale
...
bcp_mean, bcp_std, map_mean, map_std, john_mean, john_std, ndar_mean, ndar_std = split_files_jiale(data_for_test=data_for_test, MAXAGE=MAXAGE)
